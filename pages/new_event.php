...
echo '<div class="main-wrapper">
    ...
    <div class="ind-wrapper" id="event-disc-wrapper">
        ...
        <input type="text" name="event-disc" id="event-disc" required>
    </div>
    <div class="ind-wrapper" id="event-mode-wrapper">
        <label for="event-mode">Event Mode:</label>
        <select name="event-mode" id="event-mode" required>
            <option value="Offline" selected>Offline</option>
            <option value="Online">Online</option>
        </select>
    </div>
    <div class="ind-wrapper opti" id="event-venue-wrapper">
        <label for="event-venue">Event Venue:</label>
        <input type="text" name="event-venue" id="event-venue">
    </div>
    <div class="ind-wrapper opti" id="event-gmeet-wrapper">
    ...
    <div class="ind-wrapper" id="event-fees-wrapper">
        ...
        <input type="number" name="event-fees" id="event-fees" required>
    </div>
